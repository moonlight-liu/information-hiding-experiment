...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    p_embed.add_argument("--cover", default=r"G:\information_hiding\exp3\input\girl.jpg", help="输入图像路径")
    p_embed.add_argument("--out", default=r"G:\information_hiding\exp3\output\girl_watermarked.jpg", help="输出水印图像路径")
